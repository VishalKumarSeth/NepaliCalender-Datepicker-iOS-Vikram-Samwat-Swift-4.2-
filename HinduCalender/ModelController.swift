...
class ModelController: NSObject, UIPageViewControllerDataSource {
    ...
    func viewControllerAtIndex(_ index: Int) -> DataViewController? {
        ...
        let dataViewController = DataViewController.init(nibName: "DataViewController", bundle: nil)//storyboard.instantiateViewController(withIdentifier: "DataViewController") as! DataViewController
